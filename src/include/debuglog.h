...
enum ERROR_CODE: short {
	...
	*/
	...
	NETWORK_TIME_SENSITIVE_PROCESS_EXCEEDED_ALLOCATED_TIME_MINOR = DEBUG_LOG_NETWORK_OFFSET + 5,
	NETWORK_TIME_SENSITIVE_PROCESS_EXCEEDED_ALLOCATED_TIME_MAJOR = DEBUG_LOG_NETWORK_OFFSET + 6,
