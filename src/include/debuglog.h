...
namespace GLEEMAIL_DEBUG {
	...
	enum ERROR_CODE: short {
		...
		INVALID_STARTUP_CODE = 5,
		UNKNOWN_STARTUP_CODE = 6,
		...
		STORAGE_NOT_DETECTED = DEBUG_LOG_STORAGE_OFFSET + 0,
		STORAGE_COULDNT_LOAD_PREFS = DEBUG_LOG_STORAGE_OFFSET + 1,
		...
		STORAGE_UNINITIALIZED_ERASE = DEBUG_LOG_STORAGE_OFFSET + 10, //WARNING
		...
		//Preferences range: 330 - 359
		PREFERENCES_FILE_SIZE_MISMATCH = DEBUG_LOG_PREFERENCES_OFFSET + 0, //WARNING
		PREFERENCES_FILE_VERSION_MISMATCH = DEBUG_LOG_STORAGE_OFFSET + 1 //WARNING
	};
