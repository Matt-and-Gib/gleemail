...
static const constexpr unsigned short POST_ENCRYPTED_MESSAGE_INFO_MAX_MESSAGE_BUFFER_SIZE = PRE_ENCRYPTED_MESSAGE_INFO_MAX_MESSAGE_BUFFER_SIZE + ENCRYPTION_TAG_BYTES_AND_MESSAGE_COUNT_SIZE;
/*
