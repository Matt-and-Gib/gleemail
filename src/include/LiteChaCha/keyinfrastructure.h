...
public:
	...
	static const constexpr unsigned short getKeyBytes() {return KEY_BYTES;}
	static const constexpr unsigned short getSignatureBytes() {return SIGNATURE_BYTES;}
	static const constexpr unsigned short getIDBytes() {return ID_BYTES;}
