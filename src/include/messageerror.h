...
public:
	...
	explicit MessageError(const ERROR_CODE c, const char* a) {
		id = c;
		attribute = a;
	}

	explicit MessageError(const StaticJsonDocument<JSON_DOCUMENT_SIZE>& parsedDocument) {
